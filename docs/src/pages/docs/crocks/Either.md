...
context, `either` takes two functions as its arguments. The first will map any [`Left`](#left) 
value in a left instance. While the second is used to map any [`Right`](#right)
